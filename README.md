...
2. **Be specific with your solution.** Your proposal should describe the solution in enough
detail that potential implementers do not have to guess or improvise. Include images, mock-ups,
diagrams, code, if applicable. If your solution lacks in detail, is ambiguous, or otherwise
low-effort, your proposal will be closed.
